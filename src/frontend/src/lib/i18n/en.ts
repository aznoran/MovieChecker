const en = {
    ...
    archive: "Archive",
    archiveConfirm: "Move this entry to archive?",
    archivedSuccess: "Entry moved to archive",
    restore: "Restore",
    restoreSuccess: "Entry restored",
    restoreError: "Failed to restore entry",
    deleteFromArchiveConfirm: "Permanently delete this entry? This cannot be undone.",
    noArchivedEntries: "Archive is empty",
    ...
    animationSpeedDescription: "How fast cards appear and disappear",
