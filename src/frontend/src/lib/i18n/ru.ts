...
const ru: Record<TranslationKeys, string> = {
    ...
    archivedSuccess: "Запись перемещена в архив",
    restore: "Восстановить",
    restoreSuccess: "Запись восстановлена",
    restoreError: "Не удалось восстановить запись",
    deleteFromArchiveConfirm: "Удалить запись навсегда? Это действие нельзя отменить.",
    noArchivedEntries: "Архив пуст",
    ...
    animationSpeedDescription: "Скорость появления и исчезновения карточек",
    animationSpeedSlow: "Медленная",
    animationSpeedNormal: "Обычная",
    animationSpeedFast: "Быстрая",
    animationSpeedOff: "Выключена",
